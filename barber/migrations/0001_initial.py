# Generated by Django 5.2.1 on 2025-06-01 16:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_hours', models.JSONField(blank=True, default=barber.models.Barber.default_available_hours, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('barber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='barber.barber')),
            ],
            options={
                'db_table': 'categorias',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('usuario', 'usuario'), ('barbeiro', 'Barbeiro'), ('admin', 'Administrador')], default='cliente', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_cell', models.CharField(blank=True, max_length=15, null=True)),
